...
export const site = {
  name: "blog of godblf",
  desc: "Hellow World!",
  url: "https://666049.xyz",
  avatar: "https://github.com/godblf.png",
...
export const notes = [
  ...
  { title: "网站要求", content: "网站内容积极向上，无违法违规信息，不含病毒、木马、恶意代码及任何危害计算机安全内容" },
  { title: "更新与可用性", content: "网站能够正常访问，加载速度合理，支持 HTTPS 并有持续内容更新，且以原创内容为主" },
];
